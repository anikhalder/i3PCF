...
#cosmo_pars_fid = {'Omega_b': 0.046, 'Omega_m': 0.279, 'h': 0.7, 'n_s': 0.97, 'sigma8': 0.82, 'w_0': -1.0, 'w_a': 0.0, 'c_min': 3.13, 'eta_0': 0.603, 'Mv': 0.0, 'z': 0.0, 'A_IA': 0.0, 'alpha_IA': 0.0} 
...
theta_averaged_A2pt = 'no' # Average over angle for A2pt or just use bincenters
